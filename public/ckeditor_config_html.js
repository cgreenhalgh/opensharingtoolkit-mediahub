...
CKEDITOR.editorConfig = function( config ) {
	...
	// default to standard build
        config.extraPlugins = "widget,mediahubaudio";
	// config.mediahubcomment_replaceParagraphs = true;
        config.allowedContent = "h1; h2; h3; h4; p; li; ul; ol; img[alt,src,width,height]; a[href,id]; strong; em; b; i; audio[controls]; source[type,src]";
};
